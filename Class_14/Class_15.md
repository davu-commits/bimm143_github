...
There are lots of rows with zero counts. We can remove these from
further analysis.
...
![](Class_15_files/figure-commonmark/unnamed-chunk-13-1.png)
...
![](Class_15_files/figure-commonmark/unnamed-chunk-14-1.png)
...
```
    ...
    Info: Working in directory /Users/danvu/Desktop/BIMM_143/bimm_143_github/Class_14
...
![](hsa04060.pathview.png) ![](hsa05332.pathview.png) \> Q. Can you do
...
Lots of folks like the Reactome interface. You can also run this as an R
function but let’s look at the website.
...
It’s stated that the RHO GTPase cycle has the most siginificant
“Entities p-value”. These most significant pathways do not list the
previous KEGG results, but I’m unsure as to what would cause these
differences.
